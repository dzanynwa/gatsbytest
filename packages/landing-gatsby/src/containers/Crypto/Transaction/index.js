      ...
      <Container>
        <Box className="row" {...row}>
          <Box className="colleft" {...col} style={{ flexDirection: 'column' }}>
            <Text content="A New Perspective on Sales" {...sectionSubTitle} />
            <FeatureBlock
              title={
                <Heading
                  content="Increase Your Profits by 20%"
                  {...title}
                />
              }
              description={
                <Text
                  content="Smart Sales Forecasting provide you and your business with accurate and reliable forecasts can lead to huge savings and cost reductions"
                  {...description}
                />
              }
              button={<AnchorLink href="#footerSection"><Button title="CONTACT US" {...btnStyle} /></AnchorLink>}
            />
          </Box>
