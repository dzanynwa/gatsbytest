        ...
        <Box className="row" {...row}>
          <Box className="col" {...col}>
            <FeatureBlock
              title={
                <Heading
                  content="Smart Sales Forecasting"
                  {...title}
                />
              }
              description={
                <Text
                  content="Take your business to the next level with the top-notch sales forecasting algorithm that will help you save more and win more."
                  {...description}
                />
              }
              button={<ButtonGroup />}
...
BannerSection.defaultProps = {
  ...
  title: {
    fontSize: ['26px', '34px', '42px', '42px', '67px'],
    fontWeight: '700',
    color: '#fff',
